        ...
        <div class="container flex justify-between mx-auto">
            <div class="w-full lg:w-8/12">
                <div class="flex items-center justify-between">
                    <h1 class="text-xl font-bold text-gray-700 md:text-2xl" style="font-weight: bold;">Articles</h1>
                    <div>
                ...
                <div class="mt-6" >
                    <div class="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md" 
                          style="background-color:lavender; border-radius: 10px; padding:0px 10px;">
                        <div class="flex items-center justify-between">
                            <span class="font-light text-gray-600" style="font-style: italic;"> {{ $post->created_at->format('M, d Y') }} </span>
                        ...
                        <div class="flex items-center justify-between mt-4">
                            <a href="{{ route('posts.show', $post) }}"
                               ...
                               style="background-color:blue; font-weight: bold; width: 80px; text-align: center; border-radius: 5px;">
                               Voir plus
                            </a>
